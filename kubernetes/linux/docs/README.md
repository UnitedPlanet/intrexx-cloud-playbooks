...
2. Download Intrexx setup tarball via `wget https://download.unitedplanet.com/intrexx/90300/intrexx-19.09.0-linux-x86_64.tar.gz` and extract it into the repository root folder: `tar cvfz intrexx-19.09.0-linux-x86_64.tar.gz`. Then rename the `IX_19.09` folder to `intrexx`.
