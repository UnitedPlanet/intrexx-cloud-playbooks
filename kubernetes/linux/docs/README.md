...
2. Download Intrexx setup tarball via `wget https://download.unitedplanet.com/intrexx/90400/intrexx-20.03-linux-x86_64.tar.gz` and extract it into the repository root folder: `tar cvfz intrexx-19.03.0-linux-x86_64.tar.gz`. Then rename the `IX_20.03` folder to `intrexx`.
