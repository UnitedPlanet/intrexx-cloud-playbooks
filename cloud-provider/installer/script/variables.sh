...
INTREXX_SETUP_LINUX=intrexx-21.03-linux-x86_64.tar.gz
# Name of the intrexx windows setup tarball (without the path; the dir path should be set in 'DATA_DIR')
INTREXX_SETUP_WIN=intrexx-21.03-windows-x86_64.zip
...
AWS_DISK_SIZE_LINUX=100
AZ_DISK_SIZE_WIN=100
AZ_DISK_SIZE_LINUX=100
######################## 
